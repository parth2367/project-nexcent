...
const SocialIcon = ({ imgUrl }) => {
  return (
    <div className="bg-gray-900 border border-white px-2 py-2 rounded-circle">
      <img src={imgUrl} width={24} height={24} alt="social-media" />
    </div>
  );
};
...
const FooterComponent = () => {
  return (
    <Container className="d-flex flex-lg-row flex-column justify-content-lg-between justify-content-center align-items-md-center align-items-start px-5 py-5 bg-secondary font-inter gap-lg-3 gap-5">
      <div>
        <a
          href="/"
          className="navbar-brand d-flex flex-row align-items-center gap-2">
          <img src="/logo_icon.svg" width={35} height={24} alt="logo" />
        ...
        <div className="d-flex flex-column gap-2">
          ...
          <div className="input-group">
            ...
            <button className="btn btn-dark">
              <img src="/send.svg" height={20} width={20} alt="send" />
            </button>
          </div>
        </div>
      </div>
